...
const Skill = ({ darkMode, bgColor }) => {
    ...
    return (
        <div id='skill' className='p-20' data-aos="zoom-in">
            ...
            <h2 className={`text-4xl text-center font-bold py-10 px-6 ${darkMode === 'dark' ? 'text-white' : 'text-[#15295f]'}`}>My Skills</h2>
            <div
                className={`max-w-md grid grid-cols-2 gap-4 mx-auto border p-4 shadow-md ${darkMode === 'dark'
                ...
                {skills.map((skill, index) => (
                    <div key={index} className="mb-4">
                        ...
                        <div className="relative pt-1">
                            ...
                            <div className="flex">
                                <div className={`flex-grow h-2 bg-red-200 border rounded-full `}>
                                    <div
