    ...
    <ThemeContext.Consumer>
      {({ darkMode, themeColor, colorMap }) => (
        <div className="h-screen flex transition-colors duration-300">
          <div className="flex fixed overflow-y-auto h-full">
          ...
          <div
            ...
            className={`ml-96 middle-container overflow-y-auto max-h-screen w-full ${darkMode === 'dark' ? 'bg-gray-900 text-white' : 'bg-neutral-50 text-gray-900'}`}
            style={{
              scrollbarColor: `${themeColor} transparent`,
              '--dynamic-scrollbar-color': colorMap[themeColor],
            }}
